      ...
      <div className="mx-auto max-w-7xl px-6 py-8">
        ...
        <section className="grid gap-12 py-20 lg:grid-cols-[1.05fr_0.95fr] lg:items-center">
          <div>
            ...
            <div className="mt-8 flex flex-col gap-3 sm:flex-row">
              <a
                className="rounded-full bg-[--color-primary] px-6 py-3 text-center font-medium text-white"
                href="/auth"
              >
                Create a Program
              </a>
          ...
          <div className="rounded-[2rem] border border-slate-200 bg-white p-6 shadow-glow">
            <div className="grid gap-4">
              ...
              <div
                id="world-id"
                className="rounded-3xl border border-[--color-accent]/20 bg-[--color-accent]/5 p-5"
              >
        ...
        <section id="how-it-works" className="grid gap-6 pb-20 md:grid-cols-3">
          {steps.map((item) => (
            ...
            >
              <p className="text-sm font-semibold text-[--color-accent]">{item.step}</p>
              <h2 className="mt-3 text-2xl font-semibold text-[--color-primary]">
                {item.title}
              </h2>
